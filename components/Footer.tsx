      ...
      <div className="footer-container">
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <p><strong>Office 1:</strong> B-109, Joyos Hubtown, Modhera Circle, Mehsana - 384001</p>
            <p><strong>Office 2:</strong> 810, Satyamev Eminence, B/S. Saptak Bungalows, Science City Road, Sola, Ahmedabad - 380060</p>
          </div>
        </div>
